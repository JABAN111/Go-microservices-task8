...
const (
	...
	Words_GetWords_FullMethodName = "/words.Words/GetWords"
)
...
type WordsClient interface {
	...
	GetWords(ctx context.Context, in *WordsRequest, opts ...grpc.CallOption) (*WordsReply, error)
}
...
func (c *wordsClient) GetWords(ctx context.Context, in *WordsRequest, opts ...grpc.CallOption) (*WordsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WordsReply)
	err := c.cc.Invoke(ctx, Words_GetWords_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WordsServer interface {
	...
	GetWords(context.Context, *WordsRequest) (*WordsReply, error)
...
func (UnimplementedWordsServer) GetWords(context.Context, *WordsRequest) (*WordsReply, error) {
...
func _Words_GetWords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Words_GetWords_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WordsServer).GetWords(ctx, req.(*WordsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
